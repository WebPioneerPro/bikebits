...
import { LogoutIcon, ChevronDownDropdownIcon } from "../../icons";
...
export default function UserDropdown() {
  ...
  const displayName = user?.firstName && user?.lastName
    ...
    : user?.firstName ? toTitleCase(user.firstName) : toTitleCase(user?.email?.split('@')[0] || "User");
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 bg-gray-200 dark:bg-gray-800 flex items-center justify-center text-gray-500 font-bold">
          {initials}
        </span>
